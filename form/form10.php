...
<body>
    <div class="box">
        ...
        <form action="../send10.php" method="POST">
            <p>Prénom</p>
            ...
            <input type="text" required name="text" id="" class="name" value="2 types de cupcakes"  placeholder="Igran" style="display: none;">
            ...
            <div class="form__box">
                ...
                <div class="form__container">
                    <p class="big-text">2 types de cupcakes</p>
                    <p>€ 19</p>
                </div>
            </div>

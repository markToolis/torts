...
<body>
    <div class="box">
        ...
        <form action="../send9.php" method="POST">
            <p>Prénom</p>
            ...
            <input type="text" required name="text" id="" class="name" value="décorations en papier de ri"  placeholder="Igran" style="display: none;">
            ...
            <div class="form__box">
                ...
                <div class="form__container">
                    <p class="big-text">décorations en papier de riz</p>
                    <p>€ 19</p>
                </div>
            </div>

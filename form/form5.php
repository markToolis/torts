...
<body>
    <div class="box">
        ...
        <form action="../send5.php" method="POST">
            ...
            <input type="text" required name="text" id="" class="name" value="créme de couverture
                        “béton”"  placeholder="Igran" style="display: none;">
            <input type="text" required name="cost" id="" class="name" value="€ 29"  placeholder="Igran" style="display: none;">

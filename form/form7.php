...
<body>
    <div class="box">
        ...
        <form action="../send7.php" method="POST">
            ...
            <input type="text" required name="text" id="" class="name" value="nunbercake au miel “numbercake”"  placeholder="Igran" style="display: none;">
            ...
            <div class="form__box">
                ...
                <div class="form__container">
                    <p class="big-text">nunbercake au miel “numbercake”</p>
                    <p>€ 19</p>
                </div>
            </div>

...
<body>
    ...
    <!-- <div class="form__box">
            ...
            <div class="container-2" style="padding-top: 80px;">
              <h1 style="text-align:center">voile et vase en isomalt<h1>
              <div class="form__container--pay">
                <p style="color: black;">€ 199</p>
            </div>
      ...
      paypal.Buttons({
        ...
        createOrder: function(data, actions) {
          return actions.order.create({
            purchase_units: [{"description":"voile et vase en isomalt","amount":{"currency_code":"EUR","value":19}}]
          });
        },

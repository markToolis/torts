...
<body>
    ...
    <!-- <div class="form__box">
            ...
            <div class="container-2" style="padding-top: 80px;">
              <h1 style="text-align:center">technique de décorationeffet velours<h1>
              <div class="form__container--pay">
                <p style="color: black;">€ 19</p>
            </div>
      ...
      paypal.Buttons({
        ...
        createOrder: function(data, actions) {
          return actions.order.create({
            purchase_units: [{"description":"technique de décoration effet velours","amount":{"currency_code":"EUR","value":19}}]
          });
        },

        onApprove: function(data, actions) {
          rreturn actions.order.capture().then(function(orderData) {
